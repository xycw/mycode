...
<div class="headerBar">
	<div class="logoBar login_logo">
		<div class="comWidth">
			<div class="logo fl">
				<a href="#"><img src="images/logo.jpg" alt="超级管理员"></a>
			</div>
...
<div class="loginBox">
	...
	<form action="doLogin.php" method="post">
			<ul class="login">
				...
				<img id= "captcha_img "src="./getVerify.php?r=<?php echo rand();?>" alt="" />
...
<div class="footer">
	...
	<p>Copyright &copy; 2006 - 2014 &nbsp;&nbsp;&nbsp;京ICP备09037834号&nbsp;&nbsp;&nbsp;京ICP证B1034-8373号&nbsp;&nbsp;&nbsp;某市公安局XX分局备案编号：123456789123</p>
