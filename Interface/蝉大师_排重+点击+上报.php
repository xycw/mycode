...
$data = array(
    ...
    'qc_params' => array(
        'need_appid' =>array('name' => 'appid','type' =>'1','value' => '510909506'),
        'need_source' => array('name' => 'source','type' =>'1','value' => 'xiaoyuzhuanqian'),
        'need_key'=>array('name'=>'key','type'=>"1",'value'=>'eGlhb3l1emh1YW5xaWFu'),
    ...
    'click_params' => array(
        ...
        'need_callback' =>array('name'=>'callback_url','type'=>'1','value'=>'wwww.xiaoyuzhuanqian.com')
    ),
